export default function Choix() {
    const Card = ({ icon, title, desc, color }) => (
      <div className="flex flex-col items-center justify-start h-full p-6 text-center transition-all duration-300 bg-white border shadow-md hover:scale-105 rounded-xl hover:shadow-xl" id="Choix">
